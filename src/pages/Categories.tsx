                ...
                <Card sx={{ maxWidth: 345, minHeight: '100%', position: 'relative' }}>
                  ...
                  <CardContent>
                    ...
                    <Typography
                      ...
                      sx={{ wordWrap: 'break-word', maxHeight: '200px', overflow: 'hidden' }}
                    >
                      {book.volumeInfo.authors ? book.volumeInfo.authors[0] : 'Unknown author'}
                    </Typography>
                    <Chip
                      label={book.volumeInfo.pageCount ? book.volumeInfo.pageCount + ' uah' : '...'}
                      variant='outlined'
                    />
                  ...
                  <CardActions sx={{ position: 'absolute', bottom: '0', right: '0' }}>
                    {favoriteIds.includes(book.id) ? (
                      <Button onClick={() => dispatch(deleteFavItem(book.id))} size='small'>
                        From favorite
                      </Button>
                    ) : (
                      <Button
